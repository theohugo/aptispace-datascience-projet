...
- [Exécution avec Docker](#sec-docker)
  ...
  - [Exécution détaillée étape par
    étape](#exécution-détaillée-étape-par-étape)
...
Si vous ne souhaitez rien installer localement, tout le projet peut être
exécuté avec Docker Compose depuis la racine du dépôt. Le dépôt est
...
2.  Rejouer rapidement le pipeline tabulaire et vérifier les artefacts
    principaux:
...
Si vous préférez lancer chaque phase séparément, utilisez les commandes
suivantes:
