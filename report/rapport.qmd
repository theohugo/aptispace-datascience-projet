...
Le split utilisé est ici **stratifié en 80/20**, ce qui est cohérent avec un dataset synthétique sans historique longitudinal détaillé par étudiant. Sur un dataset réel multi-semestres, un découpage chronologique ou par cohorte serait préférable.
...
La validation de la branche tabulaire devra être pensée pour éviter les fuites d'information. Si les données sont organisées par semestre, il faudra privilégier un découpage chronologique. Si plusieurs lignes décrivent un même étudiant, un split par groupe ou par cohorte sera plus défendable qu'un simple tirage aléatoire.
