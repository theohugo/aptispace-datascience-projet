...
> Note de cadrage: le dépôt s'appuie désormais **par défaut** sur le jeu UCI *Predict Students' Dropout and Academic Success*, harmonisé vers le schéma du projet. Pour conserver une exécution robuste en toute circonstance, le projet garde aussi un **générateur synthétique local** utilisé en repli automatique si la source publique n'est plus accessible.
...
- le dataset tabulaire principal est désormais public et réel, mais il reste **mono-institutionnel** et déjà agrégé, ce qui limite la généralisation immédiate à d'autres établissements;
